...
HD_PWD='C:/Users/wty02/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log regfile_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source regfile_display.tcl -notrace
