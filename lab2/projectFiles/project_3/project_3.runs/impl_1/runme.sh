...
HD_PWD='C:/Users/wty02/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiply_display.tcl -notrace
