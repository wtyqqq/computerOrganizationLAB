...
HD_PWD='C:/Users/wty02/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiply_display.tcl
