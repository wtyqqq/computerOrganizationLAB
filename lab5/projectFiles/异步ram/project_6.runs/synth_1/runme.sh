...
HD_PWD='C:/Users/wty02/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_ram_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_ram_display.tcl
