...
HD_PWD='C:/Users/wty02/project_6/project_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data_ram_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data_ram_display.tcl -notrace
