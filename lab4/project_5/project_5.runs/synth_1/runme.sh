...
HD_PWD='C:/Users/wty02/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_display.tcl
