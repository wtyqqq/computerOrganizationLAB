...
HD_PWD='C:/Users/wty02/adder/adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_display.tcl
