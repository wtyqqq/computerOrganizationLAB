...
HD_PWD='C:/Users/wty02/adder/adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_display.tcl -notrace
