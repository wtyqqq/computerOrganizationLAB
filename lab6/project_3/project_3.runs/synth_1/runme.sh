...
HD_PWD='C:/Users/wty02/Pictures/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_cpu_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_cycle_cpu_display.tcl
