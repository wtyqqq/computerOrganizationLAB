...
HD_PWD='C:/Users/wty02/Pictures/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_cpu_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_cycle_cpu_display.tcl -notrace
